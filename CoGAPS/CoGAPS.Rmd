...
```{r modsim}
modsimdata <- read.table("C:/Users/mzaidi/AppData/Local/R/win-library/4.2/CoGAPS/data/ModSimData.txt")
# input to CoGAPS
modsimdata
```
...
modsimresult <- readRDS("C:/Users/mzaidi/AppData/Local/R/win-library/4.2/CoGAPS/data/ModSimResult.Rds")
```
...
```{r load single cell data from zenodo, eval=FALSE}
...
```{r load single cell data from file}
# OPTION: read data object in from file
# This file is hosted on our github repository and will be included with any github CoGAPS install,
# or can be downloaded from: https://github.com/FertigLab/CoGAPS/blob/b6b849cf84ed91f34038048e2b29ea0fcf93570b/data/inputdata.Rds
pdac_data <- readRDS("C:/Users/mzaidi/AppData/Local/R/win-library/4.2/CoGAPS/data/inputdata.Rds") # load R data object 
pdac_data
```
